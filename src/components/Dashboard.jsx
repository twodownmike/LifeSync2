                ...
                {todaysRoutines.map(routine => {
                   ...
                   return (
                      <div 
                        ...
                        className={`
                           flex-none w-40 p-4 rounded-2xl border transition-all cursor-pointer group flex flex-col justify-between min-h-[110px] snap-start relative overflow-hidden
